...
; *** Common wizard text
ClickNext=Haz click en Instalar MyApp para continuar o en Cancelar para salir de la instalación.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=Estás por instalar MyApp!
