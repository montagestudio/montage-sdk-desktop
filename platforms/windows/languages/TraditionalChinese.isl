...
; *** Common wizard text
ClickNext=點選"安裝 MyApp" 以繼續, 或點選"取消"離開安裝程式
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=您即將開始安裝 MyApp!
WelcomeLabel2=將安裝[name/ver]至您的電腦 %n%n請記得 MyApp 還在Beta測試階段, 因此我們不保證任何事, 使用者需自行承擔任何可能的風險
